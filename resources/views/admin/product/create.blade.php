                            ...
                            <div class="col-lg-6 col-12 mx-auto">
                                <form method="post" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="t-text1" type="text" name="name" placeholder="Some Text..." class="form-control" value="{{ old('name') }}" required>
												@error('name')
									...
									<div class="form-row mb-4">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="number" class="form-control" placeholder="" name="marketable_number" value="{{ old('marketable_number') }}">
