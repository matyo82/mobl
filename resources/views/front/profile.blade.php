                    ...
                    <section class="content-wrapper bg-white p-3 rounded-2 mb-2">
                        ...
                        <section class="d-flex justify-content-end my-4">
                            <a class="btn btn-link btn-sm text-info text-decoration-none mx-1" data-bs-toggle="modal"
							   ...
							   <a class="btn btn-link btn-sm text-info text-decoration-none mx-1" data-bs-toggle="modal"
                               data-bs-target="#add-address"><i class="fa fa-edit px-1"></i>افزودن ادرس</a>
                        </section>
                        ...
                        <section class="row">
                            ...
                            <section class="col-6 border-bottom my-2 py-2">
                                ...
                                <section
                                        class="field-value overflow-auto">{{ auth ()->user()->status==1 ? 'فعال' :'غیر فعال' }}</section>
                            </section>
                        ...
                        <section class="modal fade" id="add-address" tabindex="-1" aria-labelledby="add-address"
                                 aria-hidden="true">
                            <section class="modal-dialog">
                                <section class="modal-content">
                                    <section class="modal-header">
                                    ...
                                    <section class="modal-body">
                                        <form class="row" method="post"
                                            ...
                                            </section>                                             <section class="col-6 mb-2">
